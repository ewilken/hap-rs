...
pub mod accessory_information;/// Accessory Metrics service definition.
pub mod accessory_metrics;/// Accessory Runtime Information service definition.
pub mod accessory_runtime_information;/// Air Purifier service definition.
pub mod air_purifier;/// Air Quality Sensor service definition.
pub mod air_quality_sensor;/// Asset Update service definition.
pub mod asset_update;/// Assistant service definition.
pub mod assistant;/// Audio Stream Management service definition.
...
pub mod camera_recording_management;/// Camera Stream Management service definition.
...
pub mod carbon_monoxide_sensor;/// Cloud Relay service definition.
...
pub mod data_stream_transport_management;/// Diagnostics service definition.
...
pub mod input_source;/// Irrigation-System service definition.
...
pub mod lock_mechanism;/// Microphone service definition.
...
pub mod siri;/// Siri Endpoint service definition.
pub mod siri_endpoint;/// Slats service definition.
pub mod slats;/// Smart Speaker service definition.
...
pub mod stateful_programmable_switch;/// Stateless Programmable Switch service definition.
pub mod stateless_programmable_switch;/// Switch service definition.
pub mod switch;/// Target Control service definition.
pub mod target_control;/// Target Control Management service definition.
pub mod target_control_management;/// Television service definition.
pub mod television;/// Temperature Sensor service definition.
...
pub mod transfer_transport_management;/// Valve service definition.
