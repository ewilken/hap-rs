...
pub struct OnCharacteristic(Characteristic<bool>);

impl OnCharacteristic {
...
#[async_trait]
impl HapCharacteristic for OnCharacteristic {
...
impl AsyncCharacteristicCallbacks<bool> for OnCharacteristic {
