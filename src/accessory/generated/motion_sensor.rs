...
use crate::{
    ...
    service::{accessory_information::AccessoryInformation, motion_sensor, HapService},
    Result,
};
...
impl HapAccessory for MotionSensorInner {
    ...
    fn get_services(&self) -> Vec<&dyn HapAccessoryService> { vec![&self.accessory_information, &self.motion_sensor] }
