...
use crate::{
    ...
    service::{accessory_information::AccessoryInformation, lightbulb, HapService},
    Result,
};
...
impl HapAccessory for LightbulbInner {
    ...
    fn get_services(&self) -> Vec<&dyn HapAccessoryService> { vec![&self.accessory_information, &self.lightbulb] }
