...
use crate::{
    ...
    service::{accessory_information::AccessoryInformation, thermostat, HapService},
    Result,
};
...
impl HapAccessory for ThermostatInner {
    ...
    fn get_services(&self) -> Vec<&dyn HapAccessoryService> { vec![&self.accessory_information, &self.thermostat] }
