...
use crate::{
    ...
    service::{accessory_information::AccessoryInformation, leak_sensor, HapService},
    Result,
};
...
impl HapAccessory for LeakSensorInner {
    ...
    fn get_services(&self) -> Vec<&dyn HapAccessoryService> { vec![&self.accessory_information, &self.leak_sensor] }
