...
use crate::{
    ...
    service::{accessory_information::AccessoryInformation, fan_v2, HapService},
    Result,
};
...
impl HapAccessory for Fanv2Inner {
    ...
    fn get_services(&self) -> Vec<&dyn HapAccessoryService> { vec![&self.accessory_information, &self.fan_v2] }
