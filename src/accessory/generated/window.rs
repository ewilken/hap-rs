...
use crate::{
    ...
    service::{accessory_information::AccessoryInformation, window, HapService},
    Result,
};
...
impl HapAccessory for WindowInner {
    ...
    fn get_services(&self) -> Vec<&dyn HapAccessoryService> { vec![&self.accessory_information, &self.window] }
