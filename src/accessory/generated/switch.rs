...
use crate::{
    ...
    service::{accessory_information::AccessoryInformation, switch, HapService},
    Result,
};
...
impl HapAccessory for SwitchInner {
    ...
    fn get_services(&self) -> Vec<&dyn HapAccessoryService> { vec![&self.accessory_information, &self.switch] }
