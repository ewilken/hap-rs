...
impl ToString for HapType {
    fn to_string(&self) -> String {
        match self {
			...
			HapType::TunnelConnectionTimeout => "61".into(),
			HapType::TunneledAccessoryAdvertisingStatus => "60".into(),
			HapType::TunneledAccessoryConnectionStatus => "59".into(),
			HapType::TunneledAccessoryStateNumber => "58".into(),
			...
			HapType::AccessoryInformationService => "3E".into(),
...
impl FromStr for HapType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
			...
			"61" => Ok(HapType::TunnelConnectionTimeout),
			"60" => Ok(HapType::TunneledAccessoryAdvertisingStatus),
			"59" => Ok(HapType::TunneledAccessoryConnectionStatus),
			"58" => Ok(HapType::TunneledAccessoryStateNumber),
			...
			"3E" => Ok(HapType::AccessoryInformationService),
